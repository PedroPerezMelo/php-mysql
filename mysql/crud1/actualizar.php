...
<body>
  ...
  $consulta = "UPDATE PRODUCTOS SET CÓDIGOARTÍCULO='$cod', SECCIÓN='$sec', NOMBREARTÍCULO='$nom', PRECIO='$pre', FECHA='$nueva_fecha', PAÍSDEORIGEN='$por' WHERE CÓDIGOARTÍCULO = '$cod'";
